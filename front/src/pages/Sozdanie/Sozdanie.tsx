...
const defaultCategoryForPage = 'sozdanie'
...
const Sozdanie = () => {
	...
	const allowedSources = ['zoon.ru','2gis.ru','yandex.ru', 'blizko-support.com, reviewscompanies.club', 'otzovy-moskvy.ru', 'tilbagevise.ru', 'ru.gorodwiki.ru', 'wine-searcher.com'];
